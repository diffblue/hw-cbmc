...
property_checker_resultt neural_enginet::operator()()
{
  ...
  {
    throw ebmc_errort{} << "The neural engine works on omega-regular properties only";
  }
...
property_checker_resultt neural(
  ...
  message_handlert &message_handler)
{
  neural_enginet neural_engine{cmdline, transition_system, properties, message_handler};
