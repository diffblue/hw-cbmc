...
Function: expr2verilogt::convert_unbased_unsized_literal
...
expr2verilogt::resultt expr2verilogt::convert_unbased_unsized_literal(
  const verilog_unbased_unsized_literal_exprt &src)
{
  return {
